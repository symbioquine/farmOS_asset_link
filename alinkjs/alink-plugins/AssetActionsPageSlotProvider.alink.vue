<template>
  <div>
    ...
    <v-row class="ml-2" v-for="actionDef in assetLink.getRelevantActions({ asset })">
...
export default {
  ...
  onLoad(handle) {
    ...
    handle.definePageSlot('net.symbioquine.farmos_asset_link.slots.v0.actions', actionsSlot => {
