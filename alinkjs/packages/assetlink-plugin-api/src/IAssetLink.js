 ...
 *
 * @method IAssetLink#getTaxonomyTermByName
 ...
 * @description Options that can be passed to {@link IAssetLink.getOrCreateTaxonomyTermByName}
 *
 * ##### Usage
 *
 * ```js
 ...
 * ```
 *
 * @property {Boolean} idToCreate The unique id of the term to create if one cannot be found
 ...
 * ```
 *
 * @method IAssetLink#getOrCreateTaxonomyTermByName
 * @param {String} termType The type of taxonomy term to get or create. e.g. `taxonomy_term--animal_type`
