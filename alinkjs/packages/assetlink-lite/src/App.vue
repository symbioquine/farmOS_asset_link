<template>
  <q-layout view="hHh Lpr lFf">
    ...
    <q-page-container>
      <q-banner
        v-if="
          assetLink.connectionStatus.hasNetworkConnection.value && updateExists
        "
        inline-actions
...
import ModelBasedStructuralDataPreloader from "./ModelBasedStructuralDataPreloader";
...
export default defineComponent({
  ...
  setup(props, { expose }) {
    ...
    const assetLink = new AssetLink(rootComponent, devToolsApi, {
      structuralDataPreloader: new ModelBasedStructuralDataPreloader(),
      liteMode: true,
    });
